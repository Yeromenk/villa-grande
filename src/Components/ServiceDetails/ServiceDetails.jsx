            ...
            <section id="tiles-section" className="detail-section">
                ...
                <div className="detail-content">
                    <div className="detail-text">
                        ...
                        <p>Наша колекція включає керамічну плитку, керамограніт, мозаїку, а також ванни, душові кабіни, раковини, унітази, біде та змішувачі від європейських виробників.</p>
                    </div>
                    <div className="detail-image">
                        <img src="/src/assets/shabby-chic-interior-design-style.jpg" alt="Плитка та сантехніка" />
                    </div>
                </div>
            </section>
            ...
            <section id="furniture-section" className="detail-section">
                ...
                <div className="detail-content">
                    <div className="detail-text">
                        ...
                        <p>Наша майстерня створює кухні, шафи-купе, гардеробні, спальні гарнітури, вітальні та інші меблі, які ідеально вписуються у ваш простір та відповідають усім вашим вимогам.</p>
                    </div>
                    <div className="detail-image">
                        <img src="/src/assets/shabby-chic-interior-design-style.jpg" alt="Меблі на замовлення" />
                    </div>
                </div>
            </section>
        </div>
