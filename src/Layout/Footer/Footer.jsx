            ...
            <div className="footer-container">
                ...
                <div className="footer-section">
                    ...
                    <ul className="contact-list">
                        ...
                        <li className="time-item">
                            ...
                            <span>Пн-Пт: 10:00 - 19:00 <br/> Сб: 10:00 - 16:00</span>
                        </li>
                    </ul>
                </div>
                ...
                <div className="footer-section">
                    ...
                    <div className="social-icons">
                        <a href="https://www.instagram.com/villa_grande1/?igsh=YzJmZzJwaW1yZjIy#" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                            <Instagram size={22} strokeWidth={2} />
                        </a>
                        <a href="https://www.facebook.com/villagrande1?locale=ru_RU" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                            <Facebook size={22} strokeWidth={2} />
                        </a>
                    </div>

                    <h4 className="secondary-website">Наш інший сайт</h4>
                    <a href="https://kuhnya.net.ua/" target="_blank" rel="noopener noreferrer" className="external-site">
